    ...
    <section id="contact" className="py-32 md:py-29 bg-foreground text-primary-foreground">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-primary-foreground/60 text-sm tracking-[0.3em] uppercase mb-8">Liên hệ xưởng</p>

          <h2 className="text-3xl md:text-4xl lg:text-6xl font-medium leading-[1.1] tracking-tight mb-8 text-balance">
            Cần cắt gạch cho
            <br />
            công trình tại <HighlightedText>Đà Nẵng</HighlightedText>?
          </h2>

          <p className="text-primary-foreground/70 text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
            Nhận gia công cắt gạch, cắt CNC, cắt len chân tường và giao tận nơi công trình. Liên hệ để được tư vấn nhanh
            theo hạng mục của bạn.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://catgach.tndgranite.com"
              target="_blank"
              rel="noreferrer"
          ...
          <p className="text-primary-foreground/60 text-sm mt-8">Xưởng: 05 Trần Nam Trung, Hoà Xuân, Cẩm Lệ, Đà Nẵng</p>
        </div>
      </div>
    </section>
  )
